...
| History | Still idle **today** only. No list. |
...
Home, tabs, setup, scores, streaks, flashcards, SM-2, history browser, widgets, Watch, Live Activities, iCloud, a second engine, Pause during Focus, App Store launch work.
...
THE SYSTEM SHALL show 00:00, last intention, Start, and today’s focus total (device local midnight).
